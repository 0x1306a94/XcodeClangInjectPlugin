...
sudo /opt/homebrew/bin/inject $XCTOOL_CHAIN_NEW/bin/clang_arm64 -d @executable_path/../lib/libCheckerCodeStylePluginLoader.dylib
sudo /opt/homebrew/bin/inject $XCTOOL_CHAIN_NEW/bin/clang_x86_64 -d @executable_path/../lib/libCheckerCodeStylePluginLoader.dylib
